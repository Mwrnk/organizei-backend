...
exports.generateFlashcardPrompt = exports.context = exports.temperature = exports.model = void 0;
exports.model = "gpt-4o-mini";
exports.temperature = 0.5;
exports.context = "Você é um gerador de flashcards com base nos princípios de repetição espaçada, active recall e teoria da codificação dual.";
const generateFlashcardPrompt = (amount, subject, existingFronts, availableTags) => {
    return `
...
exports.generateFlashcardPrompt = generateFlashcardPrompt;
